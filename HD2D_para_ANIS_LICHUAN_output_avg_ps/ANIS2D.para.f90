...
!         cstep = cstep
      ...
      CALL MPI_BCAST(   u0,1,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,ierr) ! 11
      CALL MPI_BCAST(  kdn,1,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,ierr) ! 12
      CALL MPI_BCAST(  kup,1,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,ierr) ! 13
      CALL MPI_BCAST(   nu,1,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,ierr) ! 14
      CALL MPI_BCAST(  hnu,1,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,ierr) ! 15
      CALL MPI_BCAST(   nn,1,MPI_INTEGER,         0,MPI_COMM_WORLD,ierr) ! 16
      CALL MPI_BCAST(   mm,1,MPI_INTEGER,         0,MPI_COMM_WORLD,ierr) ! 17
...
! with the power spectrum
         ...
         IF (times.eq.sstep) THEN
           ...
           CALL yavg_ps(ps,C6,R2,ext4,odir)
